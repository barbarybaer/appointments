...
$route['addAppt'] = 'Appointments/addAppointment';
$route['update/(:num)'] = 'Appointments/updateAppointmentPage/$1';
$route['delete/(:num)'] = 'Appointments/deleteAppointment/$1';
$route['doUpdate/(:num)'] =  'Appointments/doUpdate/$1';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
